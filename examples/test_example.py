...
# SETTINGS
sample_rate = 48000
mic_type = 'binaural' #'mono', 'binaural', 'ambisonics'
...
wavfile.write('data/output/output_test.wav', sample_rate, obs.T)
