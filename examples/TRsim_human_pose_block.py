...
def run_soundspaces_per_n(n, tmp_scene_dataset, indirect_ray_count=5000, mic_location=None, audio_samples=-1, save_wav=False):
    ...
    if save_wav:
        wavfile.write(f'data/output/{DATA}/{FOLDER}/deconvolved_{N}_{INDIRECT_RAY_COUNT}_mic{MIC_IDX}.wav', 48000, obs.T)
...
DATA = 'TRsim_human_pose_block'
FOLDER = 'human_pose_block' #'adjusted_mp3d'
...
for MIC_IDX in range(0, MIC_CHANNELS):
