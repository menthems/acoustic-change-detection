...
backend_cfg.scene_id = "data/scene_datasets/replica_cad/stages/frl_apartment_stage.glb" #try5.glb"
backend_cfg.scene_dataset_config_file = "data/scene_datasets/replica_cad/replicaCAD.scene_dataset_config.json"
...
audio_sensor.setAudioMaterialsJSON("data/mp3d_material_config.json") # ! Still need to change to "try" one
...
wavfile.write('data/replica_output.wav', 16000, obs.T)
