...
backend_cfg.scene_id = "data/scene_datasets/sim/stages/treated_room_cube.glb" #"data/scene_datasets/sim/configs/scenes/not_empty.scene_instance.json" #"data/scene_datasets/sim/stages/cube_stage.glb" #"data/scene_datasets/trial/try/cube_15153.glb" #try5.glb"
backend_cfg.scene_dataset_config_file = "data/scene_datasets/sim/treated_room_cube.scene_dataset_config.json"
...
state.rotation = quat
state.position = mn.Vector3(3.048000, 1.277938, 3.657600)
...
wavfile.write('data/output/transform_mic0_cube.wav', 48000, obs.T)
